...
const primeraDivisionItems = ref([
  { image: '/assets/menu/equipo.jpg', name: 'Equipos', link: '/primera-division/tabla-completa' },
  { image: '/assets/menu/resultado.jpg', name: 'Resultados', link: '/primera-division/resultados' },
  { image: '/assets/menu/jugadores.jpg', name: 'Jugadores', link: '/primera-division/jugadores' },
  { image: '/assets/menu/partidos.jpg', name: 'Partidos', link: '/primera-division/partidos' },
  { image: '/assets/menu/arbitros.jpg', name: 'Arbitros', link: '/primera-division/arbitros' },
]);

// Datos para el carrusel de Segunda División
const segundaDivisionItems = ref([
  { image: '/assets/menu/resultado.jpg', name: 'Resultados', link: '/segunda-division/resultados' },
  { image: '/assets/menu/equipo.jpg', name: 'Equipos', link: '/segunda-division/tabla-completa' },
  { image: '/assets/menu/partidos.jpg', name: 'Partidos', link: '/segunda-division/partidos' },
  { image: '/assets/menu/jugadores.jpg', name: 'Jugadores', link: '/segunda-division/jugadores' },
  { image: '/assets/menu/arbitros.jpg', name: 'Arbitros', link: '/segunda-division/arbitros' },
]);
